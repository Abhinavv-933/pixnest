  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <h2 style={styles.title}>Join the Studio</h2>
        <p style={styles.sub}>Create a workspace to vault your creative assets</p>
        ...
        <p style={styles.footerLink}>
          Already have a vault? <Link to="/login" style={styles.link}>Sign In</Link>
        </p>
      </div>
    </div>
  );
